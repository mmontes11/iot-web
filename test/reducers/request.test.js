...
describe("reducers/request", () => {
  ...
  it("reduces nothing", () => {
    expect(requestReducer(initialState, { type: "WHATEVER" })).toMatchSnapshot();
  });
  it("reduces /_REQUEST$/", () => {
    expect(requestReducer(initialState, { type: LOGIN_REQUEST })).toMatchSnapshot();
  ...
  it("reduces /_REQUEST_SUCCESS$/", () => {
    ...
    expect(requestReducer(initialState, { type: LOGIN_REQUEST_ERROR })).toMatchSnapshot();
  });
